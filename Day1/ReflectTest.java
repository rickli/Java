...
public class ReflectTest {
	...
	public ReflectTest() {
		...
		//调用有参构造函数****************************************************************************
		/*try {
			Constructor c = getReflectBean("step1.reflect.DemoBean")
		...
		//*******************************************************************************************
		//callNoReturnNoArgsMethod("step1.reflect.DemoBean","setInt");//调用无返无参
		
		//callNoReturnArgsMethod("step1.reflect.DemoBean","setInt");//调用有参无返回方法
		
		//System.out.println(callReturnNoArgsMethod("step1.reflect.DemoBean","getInt1"));//调用有返回无参
		
		//System.out.println(callReturnArgsMethod("step1.reflect.DemoBean","getInt2"));//调用有返回有参
